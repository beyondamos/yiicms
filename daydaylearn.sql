...
CREATE TABLE IF NOT EXISTS `nav` (
  ...
  `is_blank` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否新窗口，1为新窗口，0为0',
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '导航状态，是否显示，1为显示，0为不显示',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='导航表' AUTO_INCREMENT=1 ;
