...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-07-14 09:05:24
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
INSERT INTO `article` (`id`, `title`, `catid`, `thumbnail`, `keywords`, `abstract`, `text`, `author`, `status`, `createtime`, `updatetime`) VALUES
(1, '测试信息', 1, '', '', '', '测试文章', 'xiaoming', 0, 0, 0),
(2, '测试文章2', 7, '', '', '', '<h1>\r\n	测试文章2\r\n</h1>', '小明', 1, 1499415862, 0),
(3, '测试文章3', 3, '', '', '', '测试文章3', '小明', 0, 1499415906, 0);
